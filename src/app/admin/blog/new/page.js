    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                <Link href="/admin/blog" className="p-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="glass-panel rounded-xl p-8 border border-white/10 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-2">Slug (Optional)</label>
                            <input
                                type="text"
                                name="slug"
                                value={formData.slug}
