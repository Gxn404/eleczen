    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                <Link href="/admin/components" className="p-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="glass-panel rounded-xl p-8 border border-white/10 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-2">Component Name</label>
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Resistor" className="bg-black">Resistor</option>
                                <option value="Capacitor" className="bg-black">Capacitor</option>
                                <option value="Inductor" className="bg-black">Inductor</option>
                                <option value="Diode" className="bg-black">Diode</option>
                                <option value="Transistor" className="bg-black">Transistor</option>
                                <option value="IC" className="bg-black">Integrated Circuit</option>
                                <option value="Sensor" className="bg-black">Sensor</option>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-400 mb-2">Symbol URL (Optional)</label>
                        <input
                            type="text"
                            name="symbol"
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-4">
                            <label className="block text-sm font-medium text-gray-400">Specifications</label>
                            <button
                                type="button"
                                onClick={addSpec}
