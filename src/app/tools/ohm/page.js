                ...
                <div className="glass-panel rounded-3xl p-8 border border-white/10 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-neon-blue uppercase tracking-wider">Voltage (V)</label>
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="0"
                                />
                                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 font-bold">Volts</span>
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-neon-pink uppercase tracking-wider">Current (I)</label>
                            <div className="relative">
                                <input
                                    type="number"
                                    name="i"
                                    ...
                                    placeholder="0"
                                />
                                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 font-bold">Amps</span>
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-yellow-400 uppercase tracking-wider">Resistance (R)</label>
                            <div className="relative">
                                <input
                                    type="number"
                                    name="r"
                                    ...
                                    placeholder="0"
                                />
                                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 font-bold">Ω</span>
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-neon-purple uppercase tracking-wider">Power (P)</label>
                            <div className="relative">
                                <input
                                    type="number"
                                    name="p"
                                    ...
                                    placeholder="0"
                                />
                                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 font-bold">Watts</span>
                            </div>
                        </div>
                    </div>
