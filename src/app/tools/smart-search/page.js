...
const KNOWLEDGE_BASE = [
  {
    ...
    description:
      "A popular small-signal N-channel MOSFET. Good for low-power switching.",
  ...
  },
  {
    ...
    description:
      "Industry standard dual operational amplifier. Single supply operation.",
  ...
  },
  {
    ...
    description:
      "The legendary timer IC. Used for delays, oscillation, and pulse generation.",
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4 flex items-center justify-center gap-3">
            <Sparkles className="text-neon-blue w-10 h-10" /> Smart Component
            Search
          </h1>
          <p className="text-gray-400 text-lg">
            ...
            <span className="text-sm text-gray-500">
              Try "low power opamp" or "switch mosfet"
            </span>
          </p>
        </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {item.alternatives.map((alt) => (
                    <span
                      key={alt}
                      className="px-3 py-1 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-sm text-gray-300 cursor-pointer transition-colors"
                    >
                      {alt}
                    </span>
                  ))}
          ...
          {searched && !loading && results.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">
                No AI matches found. Try different keywords.
              </p>
            </div>
          )}
        </div>
