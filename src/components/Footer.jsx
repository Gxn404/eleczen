                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            The ultimate platform for electronics engineers. Design, simulate, and discover components with AI-powered tools.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li><Link href="/encyclopedia" className="hover:text-neon-blue transition-colors">Encyclopedia</Link></li>
                            <li><Link href="/tools" className="hover:text-neon-blue transition-colors">Tools & Calculators</Link></li>
                            <li><Link href="/showcase" className="hover:text-neon-blue transition-colors">Community Showcase</Link></li>
                            <li><Link href="/blog" className="hover:text-neon-blue transition-colors">Engineering Blog</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><Link href="/contact" className="hover:text-neon-blue transition-colors">Contact Support</Link></li>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mb-4">Get the latest tools and tutorials delivered to your inbox.</p>
